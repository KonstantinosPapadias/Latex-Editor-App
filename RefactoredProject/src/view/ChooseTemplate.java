	...
	private void initialize() {
		...
		btnCreate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(book.isSelected()) {
					documentManager.setCurrentDocument(new Document("bookTemplate"));
				} else if(report.isSelected()) {
					documentManager.setCurrentDocument(new Document("reportTemplate"));
				} else if(article.isSelected()) {
					documentManager.setCurrentDocument(new Document("articleTemplate"));
				} else if(letter.isSelected()) {
					documentManager.setCurrentDocument(new Document("letterTemplate"));
				} else {
